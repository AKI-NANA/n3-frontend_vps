...
export const LOGISTICS_L3_TABS = [{id:'shipping', label:'配送管理'},{id:'matrix', label:'送料計算'}];
export const LOGISTICS_L3_TABS = [{id:'shipping', label:'配送管理'}];

export const LOGISTICS_L3_TABS = [{id:'shipping', label:'配送'}, {id:'matrix', label:'送料'}];
