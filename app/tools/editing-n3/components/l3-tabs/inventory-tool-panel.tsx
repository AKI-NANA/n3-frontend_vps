...
/**
 * 有在庫タブ用ツールパネル (Supusi同期 v4 - マルチシート対応)
 */
    ...
    <div style={{ padding: '8px 12px' }}>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          {/* プッシュ（DB → シート） */}
          <N3Tooltip content={`📤 DBの内容を「${SHEET_LABELS[selectedSheet]}」シートに書き出し（シートが上書きされます）`}>
            <button
          ...
          {/* プル（シート → DB） */}
          <N3Tooltip content={`📥 「${SHEET_LABELS[selectedSheet]}」シートの変更をDBに反映（UIに反映）`}>
            <button
          ...
          {/* シートを開く */}
          <N3Tooltip content={`${SHEET_LABELS[selectedSheet]}シートを開く`}>
            <button
        ...
        <N3Tooltip content="外注スタッフ用棚卸しツール">
          <a
