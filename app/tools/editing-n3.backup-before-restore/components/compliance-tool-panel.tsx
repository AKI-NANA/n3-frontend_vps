...
export const COMPLIANCE_L3_TABS = [{id:'vero', label:'知的財産'},{id:'hts', label:'HTSコード'}];
export const COMPLIANCE_L3_TABS = [{id:'vero', label:'知的財産'}];

export const COMPLIANCE_L3_TABS = [{id:'vero', label:'知財'}, {id:'hts', label:'HTS'}];

export const COMPLIANCE_L3_TABS = [{id:'vero', label:'知財管理'}];
