...
export const MEDIA_L3_TABS = [{id:'images', label:'画像管理'},{id:'html', label:'HTML生成'}];
export const MEDIA_L3_TABS = [{id:'images', label:'画像管理'}];

export const MEDIA_L3_TABS = [{id:'images', label:'画像'}, {id:'html', label:'HTML'}];
