...
import {
  Search, Package, DollarSign, ExternalLink, Loader2,
  TrendingUp, Calendar, Star, AlertCircle
} from 'lucide-react';
import {
  N3Button,
  N3Input,
  ...
  const handleSearch = useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setItems(data.items || []);
        showToast({ type: 'success', message: `${data.items?.length || 0}件の商品を取得しました` });
      } else {
      ...
      setItems([
        {
          id: '1',
          itemId: '123456789',
          title: 'Vintage Rolex Submariner Watch - Excellent Condition',
          price: 8500,
          soldPrice: 8200,
          currency: 'USD',
          condition: 'Pre-owned',
        ...
        },
        {
          id: '2',
          itemId: '987654321',
          title: 'Pokemon Card Charizard Base Set 1st Edition PSA 10',
          price: 5000,
          soldPrice: 4800,
          currency: 'USD',
          condition: 'New',
          seller: 'card_collectors',
          soldCount: 5,
          profitScore: 92,
          imageUrl: '',
          marketplace: 'US'
