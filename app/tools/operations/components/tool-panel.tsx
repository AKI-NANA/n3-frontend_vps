// app/tools/operations/components/tool-panel.tsx
// コピー元: editing/components/tool-panel.tsx
...
const IconBtn = ({
  icon: Icon, label, tooltip, onClick, disabled, active, badge, variant = "ghost"
}: {
  icon: any; label: string; tooltip?: string; onClick: () => void; disabled?: boolean; active?: boolean; badge?: number; variant?: "ghost" | "primary" | "danger"
}) => (
  <button
    onClick={onClick}
    disabled={disabled}
